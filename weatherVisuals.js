/* UI polish: compact HUD. Weather particles only; clouds and sun are rendered in the 3D sky. */
(() => {
  ...
  style.textContent = `
    ...
    @media(max-width:900px){#res{left:195px;right:10px;top:0}#stats{right:10px;top:50px;width:auto;max-width:calc(100vw - 215px)}#researchPoints{top:50px}#weather{top:88px}#tools{width:min(470px,55vw);grid-template-columns:repeat(3,minmax(95px,1fr))}.window{width:min(360px,calc(100vw - 245px))}}
    @media(max-width:650px){#ui{inset:6px}#panel>.title{width:155px;font-size:15px}#res{left:160px;right:0;grid-template-columns:repeat(5,minmax(48px,1fr));gap:2px}#res .res{min-height:38px;font-size:7px;padding:2px}#res .res b{font-size:12px}#stats{left:0;right:auto;top:50px;max-width:100%;font-size:9px}#researchPoints{left:0;top:84px}#weather{left:0;top:118px;font-size:15px}#panel>button{left:0;width:170px;height:34px;font-size:12px}#marketBtn{top:155px}#armyBtn{top:195px}#techBtn{top:235px}#peopleBtn{top:275px}#weatherBtn{top:315px}#wikiBtn{top:355px}#settingsBtn{top:395px}#tools{right:6px;bottom:6px;width:calc(100vw - 185px);max-height:155px;grid-template-columns:repeat(2,minmax(88px,1fr));padding:7px}#tools button{font-size:11px;min-height:34px}.window,#wikiWin,#settingsWin{left:180px;right:6px;width:auto;top:48px;max-height:70vh}#adminWin{left:6px;width:300px}}
  `;
...
if (weatherEl) {
  ...
  function frame(now){const dt=Math.min(.05,(now-last)/1000);last=now;ctx.clearRect(0,0,innerWidth,innerHeight);const label=weatherEl.textContent||'';setWeather(label);
    if(label.includes('Beau temps')){overlay(.035,'#fff4c2');}
